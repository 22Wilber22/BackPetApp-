...
petsRouter.get("/pets/my/archived", requireAuth, petsController.listMineArchived);
...
petsRouter.patch("/pets/:id", requireAuth, validate(petIdParamSchema), petsController.update);
